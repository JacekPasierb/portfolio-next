...
const certificateList: Record<string, Certificate> = {
    fullstack: {
        ...
        description: "Kompletny kurs FullStack obejmujący Frontend, Backend i DevOps.",
    ...
    jira: {
        title: "Jira",
        description: "Certyfikat potwierdzający umiejętność zarządzania projektami w JIRA.",
        image: "/certificates/Jira.jpg",
        link: "/certificates/jira",
    },
};
// Dynamiczna obsługa strony certyfikatu
const CertificateDetails = async ({ params }: { params: { slug: string } }) => {
